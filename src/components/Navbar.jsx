...
const Navbar = () => {
    ...
    return (
        <div className={`font-medium fixed z-10 flex justify-between w-full items-center py-3 px-2 md:px-10 lg:px-16 xl:px-28 transition-colors duration-300 ${ scroll ? 'bg-[#161616] text-white':'bg-transparent'}`}>
