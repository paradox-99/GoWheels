            ...
            <div className="lg:pr-32 xl:pr-48">
              ...
              <p className="mt-8 text-xl font-light leading-relaxed">
                <p className="text-gray-700">
                  This dashboard allows you to manage your car rental agency
                  with ease. From here, you can:
                </p>
                <ul className="list-disc list-inside my-4 text-gray-700">
                  <li>Add and manage vehicles in your fleet</li>
                  <li>Track vehicle availability and rentals</li>
                  <li>View and manage customer bookings</li>
                  <li>Monitor vehicle maintenance schedules</li>
                </ul>
              </p>
            </div>
          </div>
