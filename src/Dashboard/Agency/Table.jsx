            ...
            <table className="w-full text-left table-auto min-w-max">
                ...
                <tbody>
                    {dataToDisplay.map((vehicle) => (
                        <tr key={vehicle.licenseNumber} className="hover:bg-slate-50 border-b border-slate-200 bg-transparent">
                            <td className="p-4 py-5">
                                <p className="block font-semibold text-slate-800">{vehicle.licenseNumber}</p>
                            </td>
                            <td className="p-4 py-5">
